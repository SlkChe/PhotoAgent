...
По решению владельца от 2026-09-23 все `decisions.md` — локальные технические
файлы обмена между участниками, исключённые из Git, а не документация проекта.
Не добавляй их в коммиты. В новом checkout их нет: требования, задания и результаты
должны иметь самодостаточное описание в версионируемых целевых документах.
