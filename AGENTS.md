...
- **docs/** - директория содржит описание дизайна и архитектуры решения с разделением на этапы, например директория "docs/mvp-1/" содержит артифакты соответствующие этапу mvp-1.
