...
Для согласования оставшейся части B-01 подготовлен
[кандидат HTTP-контракта](http-contract-draft.md): операции, OpenAPI, проверяемые
JSON-примеры и вопросы H-01–H-09. Его модели изолированы в `shared/http_draft`;
это предложение, не новая утверждённая версия 1.1 и не действующий HTTP API.
